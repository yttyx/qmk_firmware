...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  ...
  /* Function/Cursor (FC)
     .---------.---------.---------.---------.---------.---------.---------.---------.---------.---------.---------.---------.
     | F1      | F2      | F3      | F4      | F5      |         |         | Home    | Up      | End     | PgUp    | Break   |
     |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
     | F6      | F7      | F8      | F9      | F10     |         | Esc     | Left    | Down    | Right   | PgDn    | Caps    |
     |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
     | Ctl     | Alt     |         | F11     | F12     |         | (SH)    | ST      |         | Alt     | Ctl     | PScr    |
     |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
     |         |         |         |         | Spc     |         | Sft     |         | Sup     |         |         |         |
     '---------'---------'---------'---------'---------'---------'---------'---------'---------'---------'---------'---------'
  */
  [_FC] = LAYOUT_planck_grid(
      KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    XXXXXXX,  XXXXXXX,  KC_HOME,  KC_UP,    KC_END,   KC_PGUP,  KC_BRK,
      KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   XXXXXXX,  KC_ESC,   KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_PGDN,  KC_CAPS,
      _______,  _______,  XXXXXXX,  KC_F11,   KC_F12,   XXXXXXX,  KC_EXEC,  TO(_ST),  XXXXXXX,  _______,  _______,  KC_PSCR,
